...
namespace HTMLEvaluationTestGDI
{
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                Console.WriteLine("Creating report with {{expression}} evaluation (GDI)...");
                ...
                // Generate GDI PDF
                string pdfPath = Path.GetFullPath("test_evaluation_gdi.pdf");
                Console.WriteLine("Generating GDI PDF: " + pdfPath);
