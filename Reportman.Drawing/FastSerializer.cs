    ...
    public class FastSerializer
    {
        ...
        private static TypeData TypeToTypeData(System.Type ntype)
        {
            ...
            switch (typestring)
            {
                ...
                case "System.Object":
                    ...
                    break;
                case "FirebirdSql.Data.Types.FbZonedDateTime":
                    coltype = TypeData.DateTime;
                    break;
                default:
        ...
        private static void WriteValue(Stream nstream, BinaryWriter nwriter, TypeData ntype, object nvalue)
        {
            ...
            switch (ntype)
            {
                ...
                case TypeData.Int64:
                    nstream.Write(bytenonull, 0, 1);
                    if (nvalue is System.Numerics.BigInteger)
                    {
                        System.Numerics.BigInteger bigInt = (System.Numerics.BigInteger)nvalue;
                        long newLong = ((long)bigInt);
                        nwriter.Write(newLong);
                    }
                    else
                    {
                        long newLong = (long)nvalue;
                        nwriter.Write(newLong);
                    }
                ...
                case TypeData.DateTime:
                    DateTime dvalue;
                    if (nvalue is DateTime)
                    {
                        dvalue = ((DateTime)nvalue);
                    }
                    else
                    {
                        object dtvalue = nvalue.GetType().GetProperty("DateTime").GetValue(nvalue);
                        //dvalue = (DateTime)nvalue.DateTime;
                        dvalue = (DateTime)dtvalue;
                    }
