...
namespace Reportman.Reporting.Forms
{
    ...
    public class ParamsControl : ScrollableControl
    {
        ...
        private void contextmenuclickselectall(object sender, EventArgs e)
        {
            ...
            CheckedListBox control = (CheckedListBox)this.CheckListBoxes[((ToolStripMenuItem)sender).GetCurrentParent().Items[0].Text];
                    ...
                    if (p.UserVisible)
                    {
                        ...
                        switch (p.ParamType)
                        {
                            ...
                            case ParamType.Multiple:
                                ...
                                ToolStripItem firstmenu = nmenu.Items.Add(p.Alias);
                                firstmenu.Visible = false;
                                ToolStripItem mselectall = nmenu.Items.Add(Translator.TranslateStr(1445));
                                ToolStripItem mclear = nmenu.Items.Add(Translator.TranslateStr(1446));
                                ...
                                cinfo.control.ContextMenuStrip = nmenu;
                                foreach (string sitem in p.Items)
