    ...
    public partial class PreviewWinFormsControl : UserControl
    {
        ...
        public PreviewWinFormsControl()
        {
            ...
            this.saveFileDialog1.Filter = Translator.TranslateStr(703) + "|*.rpmf|" +
                ...
                Translator.TranslateStr(701) + " A/3|*.pdf|" +
                Translator.TranslateStr(702) + " A/3|*.pdf|" +
                // Excel file
        ...
        private void bsfirst_Click(object sender, EventArgs e)
        {
            ...
            if (sender == BSave)
            {
                if (fmetapr.MetaFile.PDFConformance == PDFConformanceType.PDF_A_3)
                {
                    if (fmetapr.MetaFile.PDFCompressed)
                    {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    switch (saveFileDialog1.FilterIndex)
                    {
                        ...
                        case 5:
                            ...
                            if ((saveFileDialog1.FilterIndex == 2) || (saveFileDialog1.FilterIndex == 3))
                            {
                                prpdf.PDFConformance = PDFConformanceType.PDF_1_4;
                            }
                        ...
                        case 7:
                            ...
                            prex.OneSheet = (saveFileDialog1.FilterIndex == 7);
                        ...
                        case 9:
                            ...
                            {
                                if (saveFileDialog1.FilterIndex == 8)
