...
namespace Reportman.Drawing.Forms
{
	...
	public class DataGridViewAdvanced : DataGridView
    {
        ...
        protected override bool ProcessDialogKey(Keys keyData)
        {
            ...
            if (keyData == DoubleClickKey)
            {
                this.DoDoubleClick(this.EditingControl);
                return true;
            }
            if (keyData == Keys.Decimal)
            {
                ...
                if (doconvert)
                {
                    if (EditingControl is AdvancedEditingControl)
                    {
                        ...
                        {
                            DataGridViewColumnAdvanced ecolumn = (DataGridViewColumnAdvanced)ncol;
                            switch (ecolumn.DataType)
                            {
