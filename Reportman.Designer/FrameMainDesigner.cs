...
namespace Reportman.Designer
{
    public partial class FrameMainDesigner : UserControl
    {
        ...
        public FrameMainDesigner()
        {
            ...
            mseleccionar.Text = Translator.TranslateStr(21);
            mseleccionartodo.Text = Translator.TranslateStr(19);
            mseleccionartodoslostextos.Text = Translator.TranslateStr(117);
            mseleccionartodoslostextos.ToolTipText = Translator.TranslateStr(118);
            mseleccionartodo.ToolTipText = Translator.TranslateStr(20);
        ...
        private void mseleccionartodoslostextos_Click(object sender, EventArgs e)
        {
            subreportedit.SelectAll(true);
        }
